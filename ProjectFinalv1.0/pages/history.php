...
require '../partials/header.php';
    ...
    if(isset($_SESSION['lives'])){
        $l = 6 - $_SESSION['lives'];
        if($_SESSION['lives'] > 0 && !($_SESSION['row_inserted'])){
...
<?php
    ...
    echo "<div><label>Username   :</label><label>".$_SESSION['userName']."    </label></div><br>";
    echo '<br/><br/><a href = "game1.php"> PLAY GAME </a><br/><br/>';
    echo '<table>';
    echo '<tr><th>Reg.Order</th><th>ScoreTime</th><th>Result</th><th>LivesUsed</th></tr>';
    $query1 = "SELECT scoreTime, result, livesUsed FROM score WHERE registrationOrder='$regorder'";
